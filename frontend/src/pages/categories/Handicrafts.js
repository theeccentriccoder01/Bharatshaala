    ...
    <React.StrictMode>
      <div className='bg-brsl_cream h-full min-h-screen'>
        ...
        <div className='max-w-lg mx-auto'>
          ...
          <h1 className='flex text-brsl_brick font-bharatshaala text-6xl mt-5 justify-center text-center'>Handicrafts</h1>
          <div className='flex justify-center p-3'>
            <img src={img} className='h-52'></img>
          </div>
          <p className='flex text-brsl_moss font-body text-xl mb-5 justify-center text-center'>Browse through some of the most famous local markets of India<br></br>to find all kinds of traditional Indian handicrafts</p>
        </div>
