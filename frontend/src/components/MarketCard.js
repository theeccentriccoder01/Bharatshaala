        ...
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='md:w-1/3 h-48 md:h-auto relative overflow-hidden'>
            ...
            <div className='absolute top-4 left-4 bg-emerald-500 text-white px-3 py-1 rounded-full text-sm font-medium'>
              स्थापना {market.established}
            </div>
            <div className='absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center space-x-1'>
              <span className='text-yellow-500'>⭐</span>
              <span className='text-emerald-800 font-semibold text-sm'>{market.rating}</span>
            </div>
          </div>
          ...
          <div className='md:w-2/3 p-6'>
            ...
            <div className='grid grid-cols-3 gap-4 mb-4'>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                <div className='text-lg font-bold text-emerald-600'>{market.vendors}</div>
                <div className='text-emerald-600 text-xs'>विक्रेता</div>
              </div>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                <div className='text-lg font-bold text-emerald-600'>{market.reviews}</div>
                <div className='text-emerald-600 text-xs'>समीक्षाएं</div>
              </div>
              <div className='text-center bg-emerald-50 rounded-lg p-3'>
                <div className='text-lg font-bold text-emerald-600'>{market.openingHours}</div>
            ...
            <div className='mb-4'>
              <div className='flex flex-wrap gap-2'>
                {market.specialties.slice(0, 4).map((specialty, index) => (
    ...
    >
      ...
      <div className='relative h-64 overflow-hidden'>
        ...
        <div className='absolute top-4 left-4'>
          <div className='bg-gradient-to-r from-amber-400 to-orange-400 rounded-full px-4 py-2 flex items-center space-x-2'>
            <span className='text-amber-900 text-xs font-bold'>स्थापना {market.established}</span>
          </div>
        </div>
        ...
        <div className='absolute bottom-4 left-4 right-4'>
          <div className='bg-white/20 backdrop-blur-sm rounded-xl p-3 text-white'>
            <div className='flex justify-between items-center text-sm'>
              <span>{market.vendors} विक्रेता</span>
      ...
      <div className='p-6'>
        ...
        <div className='grid grid-cols-2 gap-4 mb-6'>
          ...
          <div className='text-center bg-emerald-50 rounded-lg p-3'>
            <div className='text-lg font-bold text-emerald-600'>{market.avgPrice}</div>
